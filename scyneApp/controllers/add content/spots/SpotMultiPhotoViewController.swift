//
//  SpotMultiPhotoViewController.swift
//  scyneApp
//
...
class SpotMultiPhotoViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        pageControl.frame = CGRect(x: (view.width - 160)/2, y: scrollView.bottom + 10, width: 160, height: 20)
    ...
    @objc func didTapMore() {
        let vc = SpotCameraViewController(images: self.images)
    ...
    @objc func didTapNext() {
        if address == "" {
            ...
            let vc = SpotTypeViewController(images: self.images, longitude: self.longitude, latitude: latitude, address: address)
            navigationController?.pushViewController(vc, animated: true)
        }
    }
...
extension SpotMultiPhotoViewController: UIScrollViewDelegate {
