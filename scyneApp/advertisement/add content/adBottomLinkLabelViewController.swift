//
//  adBottomLinkLabelViewController.swift
//  scyneApp
//
...
class adBottomLinkLabelViewController: UIViewController {
    ...
    init(company: String, logo: UIImage, link: String, url: URL, product: String) {
    ...
    @objc func didTapNext() {
        ...
        let vc = adVideoCaptionViewController(company: self.companyName, logo: self.companyLogo, link: self.companyLink, url: self.url, product: self.productLink, text: textLabel)
