//
//  adPhotoAskForMoreViewController.swift
//  scyneApp
//
...
class adPhotoAskForMoreViewController: UIViewController {
    ...
    @objc func didTapMore() {
        let vc = adPhotoSelectorViewController(company: self.companyName, logo: self.companyLogo, link: self.companyLink, images: self.images)
...
extension adPhotoAskForMoreViewController: UIScrollViewDelegate {
